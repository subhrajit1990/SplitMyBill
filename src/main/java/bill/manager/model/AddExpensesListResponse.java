...
public class AddExpensesListResponse {
	...
	private Map<Long,List<AddExpensesResponse>> addExpenseListResponse;

	public Map<Long, List<AddExpensesResponse>> getAddExpenseListResponse() {
		return addExpenseListResponse;
	}

	public void setAddExpenseListResponse(Map<Long, List<AddExpensesResponse>> addExpenseListResponse) {
