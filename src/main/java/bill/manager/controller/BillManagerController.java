...
public class BillManagerController {
	...
	public ResponseEntity<CreateGroupResponseWrapper> groupCreation(
		...
		try {
			...
			if (createGroupResponse.getGroupStatus().equalsIgnoreCase(ErrorConstants.SUCCESS)) {
	...
	public String addExpenses(@RequestBody AddExpensesRequestWrapper addExpensesRequestWrapper,
		...
		billManagerService.addExpenses(addExpensesRequestWrapper.getAddExpensesRequest());
